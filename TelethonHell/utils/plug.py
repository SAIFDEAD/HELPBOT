...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        LOGS.info("⚡Dead UserBot⚡ - Successfully imported " + shortname)
    else:
        import TelethonHell.utils
...
async def plug_channel(client, channel):
    if channel != 0:
        LOGS.info("⚡ Dead Userbot ⚡ - PLUGIN CHANNEL DETECTED.")
        LOGS.info("⚡ Dead Userbot ⚡ - Starting to load extra plugins.")
