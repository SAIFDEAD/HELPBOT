...
async def logger_id(client):
    desc = "A Bot Logger Group For Dead Userbot. DO NOT LEAVE THIS GROUP!!"
    try:
        grp = await client(
            functions.channels.CreateChannelRequest(
                title="ᴅɪᴄᴛᴀᴛᴏʀ ᴜsᴇʀʙᴏᴛ", about=desc, megagroup=True
            )
        )
...
<b><i>»» <u><a href='https://t.me/SAIFALLBOT'>ᴅɪᴄᴛᴀᴛᴏʀ ʟᴀɴᴅ</a></u> ««</i></b>
"""
    await client.send_file(
        ...
        caption=text,
        parse_mode="HTML",
        buttons=[[Button.url("DeadBot Network", "https://t.me/SAIFHELPGC")]],
    )
